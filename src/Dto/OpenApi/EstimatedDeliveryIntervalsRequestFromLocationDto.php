...
/**
 * OpenAPI schema: EstimatedDeliveryIntervalsRequestFromLocationDto
 *
 * Адрес отправления. Не может использоваться одновременно с shipment_point. Обязателен, если заказ с тарифом "от двери".
 */
final readonly class EstimatedDeliveryIntervalsRequestFromLocationDto
{
    public mixed $code;
