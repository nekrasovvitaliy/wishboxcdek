...
/**
 * OpenAPI schema: ReverseValidateRequestToLocationDto
 *
 * Адрес получения. Не может использоваться одновременно с delivery_point. Обязательное поле, если тариф с режимом "до двери"
 */
final readonly class ReverseValidateRequestToLocationDto
{
    public mixed $code;
