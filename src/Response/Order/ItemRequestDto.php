...
final readonly class ItemRequestDto
{
    public function __construct(
        public ?string $name = null,
        public ?string $wareKey = null,
        public ?string $marking = null,
        public ?MoneyDto $payment = null,
        ...
        public ?ReturnItemDetailDto $returnItemDetail = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            payment: isset($data['payment']) && is_array($data['payment']) ? MoneyDto::fromArray($data['payment']) : null,
            ...
            returnItemDetail: isset($data['return_item_detail']) && is_array($data['return_item_detail']) ? ReturnItemDetailDto::fromArray($data['return_item_detail']) : null,
