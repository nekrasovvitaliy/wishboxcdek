...
final readonly class DeliveryDetailsResponse
{
    /**
    ...
    public function __construct(
        public ?DeliveryEntityDto $entity = null,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            entity: isset($data['entity']) && is_array($data['entity']) ? DeliveryEntityDto::fromArray($data['entity']) : null,
            requests: $requests,
