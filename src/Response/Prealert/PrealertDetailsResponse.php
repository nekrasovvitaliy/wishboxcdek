...
final readonly class PrealertDetailsResponse
{
    /**
    ...
    public function __construct(
        public ?PrealertEntityDto $entity = null,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            entity: isset($data['entity']) && is_array($data['entity']) ? PrealertEntityDto::fromArray($data['entity']) : null,
            requests: $requests,
