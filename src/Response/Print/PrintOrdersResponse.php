...
final readonly class PrintOrdersResponse
{
    /**
    ...
    public function __construct(
        public ?PrintOrdersEntityDto $entity = null,
    ...
    public static function fromArray(array $data): self
    {
        ...
        return new self(
            entity: isset($data['entity']) && is_array($data['entity']) ? PrintOrdersEntityDto::fromArray($data['entity']) : null,
            requests: $requests,
